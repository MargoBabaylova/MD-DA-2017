...
По количеству строк по столбцу можно посчитать количество записей в датафрейме. Всего: 93
...
Результаты различаются, т.к. для оптимизации выпуска продукции используется случайное число по равномерному закону распредения *runif()*
